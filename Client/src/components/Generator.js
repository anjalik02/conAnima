...
class Generator extends Component {
 ...
 <p> </p>
 <input style={{width: "100%"}} type="submit" value="Generate Ideas" />
 </form>
 <p> </p>
 {this.state.submit &&
 <span><strong>Suggested Words: </strong>{this.state.keywords}
 <br />
 <strong>Suggested Chord Progression: </strong>{this.state.chordProgression}
 </span>}
 </header>
 </div>
 </Container>
